            ...
            return(
                ...
                <img src={`http://openweathermap.org/img/wn/${dayData.weather[0].icon}@2x.png`} alt="" />
                 ...
                 <div className="daydetails">
                    ...
                    <h5><img src="https://img-premium.flaticon.com/png/128/3525/premium/3525832.png?token=exp=1633268661~hmac=baca71181e1eb1a881a6058a403c85c5" alt="" /></h5>
                    <h5 className="hdata">{dayData.pressure} In</h5>
                    ...
                    <h5 className="hdata">Wind Speed Km/h</h5>
                     </div>
                 </div>
                </div>
            )
